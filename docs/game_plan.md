...
1. Catch fish from water tiles.
2. Store live fish in pool tiles.
3. Process fish into meat with cutter tiles.
4. Sell meat through market tiles.
5. Spend money on more tiles, better tools, machines, space, and defenses.
